...
/**
 * Entidad de dominio que representa un ítem del pedido.
 * Inmutable.
 */
public class OrderItemDomain {
    ...
    public OrderItemDomain(Long id, Long productId, Integer quantityInBaseUnits, String displayQuantity, BigDecimal unitPrice, BigDecimal subtotal, Long unitMeasureId) {

...
@TenantAware
@Service
public class OutletSecurityImpl
        extends TenantSecurity
    ...
    public OutletSecurityImpl(OutletRepository outletRepository, OutletMapper outletMapper, MasterDataService masterDataService, ApplicationContext applicationContext, JwtUtils jwtUtils) {

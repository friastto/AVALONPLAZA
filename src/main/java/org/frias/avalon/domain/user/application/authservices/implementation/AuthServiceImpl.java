package org.frias.avalon.domain.user.application.authservices.implementation;
...
public class AuthServiceImpl implements AuthService {
    ...
    public AuthResponse login(String username, String password) {
        ...
        UserAvalon usuario = usuarioRepo.findByUserName(username)
                .orElseThrow(() -> new UsernameNotFoundException("Usuario no encontrado"));

        // Verificación de contraseña con salt hash
        if (!PassSecure.verifyPassword(password, usuario.getHashSalt(), usuario.getHashPassword())) {

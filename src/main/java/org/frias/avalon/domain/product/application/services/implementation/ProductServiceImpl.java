...
import org.frias.avalon.domain.product.infraestructure.BarcodeRepository;
import org.frias.avalon.domain.product.infraestructure.ProductRepository;
import org.frias.avalon.domain.product.application.services.interfaces.ProductoBarcodeServices;
import org.frias.avalon.domain.product.application.services.interfaces.ProductoService;
import org.frias.avalon.domain.product.application.services.interfaces.ProductoServiceEcommerce;
...
, ProductoBarcodeServices {
    ...
    @Transactional
    @Override
    public ProductAvalonResponseDto save(ProductRequestCreate request, MultipartFile imgUrl) {
...
//                .orElse(null);
    ...
    @Override
    public List<ProductAvalonResponseDto> findAll() {
    ...
    public void deleteById(Long id) {
        productRepository.delete(searchById(id));
    }

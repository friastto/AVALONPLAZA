package org.frias.avalon.temp.jwt.util;
...
public class JwtUtils {
    ...
    public String generateToken(UserDetails userDetails, Long empresaId, Long outletId) {
    ...
    private String extractCleanRole(UserDetails userDetails) {
